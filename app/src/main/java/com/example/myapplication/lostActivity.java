...
public class lostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lostList.add(new Lost('1', "cat1", "Потерялся кот неизвестной породы, на вид полосатый и довольно глупый, просьба верну...", "Екатеринбург, ул. Луначарского 51"));
        lostList.add(new Lost('2', "cat2", "Потерялась кошка породы саванна, окликается на кличку Паприка, последний раз видели...", "Екатеринбург, ул. Азина, 20к2"));
        lostList.add(new Lost('3', "cat3", "Потерялся серый кот Сажа, очень опасен и агресивен, просьба вернуть по следующему а...", "Екатеринбург, ул. Испанских рабочих, 35"));
